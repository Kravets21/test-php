...
/**
     ...
     *
     * @param  \AirEml\Model\EmailChannelRequest $email_channel_request email_channel_request (required)
     ...
     * @return \AirEml\Model\EmailChannelResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * Create a New Email Notification Channel
     *
     * @param  \AirEml\Model\EmailChannelRequest $email_channel_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailChannel'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEmailChannelWithHttpInfo($email_channel_request, string $contentType = self::contentTypes['createEmailChannel'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\AirEml\Model\EmailChannelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailChannelResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailChannelResponse', []),
            ...
            $returnType = '\AirEml\Model\EmailChannelResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailChannelResponse',
     ...
     * @param  \AirEml\Model\EmailRoutingRuleCreateRequest $email_routing_rule_create_request email_routing_rule_create_request (required)
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelRoutingRuleResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     *
     * @param  string $channel_id The ID of the Channel (required)
     * @param  \AirEml\Model\EmailRoutingRuleCreateRequest $email_routing_rule_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailChannelRoutingRule'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelRoutingRuleResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEmailChannelRoutingRuleWithHttpInfo($channel_id, $email_routing_rule_create_request, string $contentType = self::contentTypes['createEmailChannelRoutingRule'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\AirEml\Model\EmailChannelRoutingRuleResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailChannelRoutingRuleResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailChannelRoutingRuleResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\AirEml\Model\EmailChannelRoutingRuleResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailChannelRoutingRuleResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \AirEml\Model\EmailSenderCreateRequest $email_sender_create_request email_sender_create_request (required)
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailSenderResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * Create a New Email Notification Sender
     *
     * @param  \AirEml\Model\EmailSenderCreateRequest $email_sender_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailSender'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailSenderResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEmailSenderWithHttpInfo($email_sender_create_request, string $contentType = self::contentTypes['createEmailSender'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\AirEml\Model\EmailSenderResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailSenderResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailSenderResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\AirEml\Model\EmailSenderResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailSenderResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \AirEml\Model\EmailTransportCreateRequest $email_transport_create_request email_transport_create_request (required)
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailTransportResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * Create a New Email Notification Transport
     *
     * @param  \AirEml\Model\EmailTransportCreateRequest $email_transport_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailTransport'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailTransportResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createEmailTransportWithHttpInfo($email_transport_create_request, string $contentType = self::contentTypes['createEmailTransport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\AirEml\Model\EmailTransportResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailTransportResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailTransportResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\AirEml\Model\EmailTransportResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailTransportResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelRoutingRuleResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelRoutingRuleResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailSenderResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailSenderResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailTransportResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailTransportResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelRoutingRulesCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelRoutingRulesCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEmailChannelRoutingRulesWithHttpInfo($channel_id, $cursor = null, $per_page = 20, $order_by = null, string $contentType = self::contentTypes['listEmailChannelRoutingRules'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AirEml\Model\EmailChannelRoutingRulesCollectionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailChannelRoutingRulesCollectionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailChannelRoutingRulesCollectionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\AirEml\Model\EmailChannelRoutingRulesCollectionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailChannelRoutingRulesCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEmailChannelsWithHttpInfo($cursor = null, $per_page = 20, $order_by = null, $name = null, string $contentType = self::contentTypes['listEmailChannels'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AirEml\Model\EmailChannelCollectionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailChannelCollectionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailChannelCollectionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\AirEml\Model\EmailChannelCollectionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailChannelCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailSenderCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailSenderCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEmailSendersWithHttpInfo($cursor = null, $per_page = 20, $order_by = null, $name = null, string $contentType = self::contentTypes['listEmailSenders'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AirEml\Model\EmailSenderCollectionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailSenderCollectionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailSenderCollectionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\AirEml\Model\EmailSenderCollectionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailSenderCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailTransportCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailTransportCollectionResponse|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEmailTransportsWithHttpInfo($cursor = null, $per_page = 20, $order_by = null, $name = null, $status = null, string $contentType = self::contentTypes['listEmailTransports'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AirEml\Model\EmailTransportCollectionResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AirEml\Model\EmailTransportCollectionResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\AirEml\Model\EmailTransportCollectionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\AirEml\Model\EmailTransportCollectionResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AirEml\Model\EmailTransportCollectionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailChannelResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailChannelResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string $channel_id The ID of the Channel (required)
     * @param  string $routing_rule_id The ID of the Routing-rule (required)
     * @param  \AirEml\Model\EmailRoutingRuleUpdateRequest $email_routing_rule_update_request email_routing_rule_update_request (required)
     ...
     * @param  string $channel_id The ID of the Channel (required)
     * @param  string $routing_rule_id The ID of the Routing-rule (required)
     * @param  \AirEml\Model\EmailRoutingRuleUpdateRequest $email_routing_rule_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateEmailChannelRoutingRule'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $sender_id The ID of the Sender (required)
     * @param  \AirEml\Model\EmailSenderUpdateRequest $email_sender_update_request email_sender_update_request (required)
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailSenderResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     *
     * @param  string $sender_id The ID of the Sender (required)
     * @param  \AirEml\Model\EmailSenderUpdateRequest $email_sender_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateEmailSender'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailSenderResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $transport_id The ID of the Transport (required)
     * @param  \AirEml\Model\EmailTransportUpdateRequest $email_transport_update_request email_transport_update_request (required)
     ...
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \AirEml\Model\EmailTransportResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error
     */
     ...
     *
     * @param  string $transport_id The ID of the Transport (required)
     * @param  \AirEml\Model\EmailTransportUpdateRequest $email_transport_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateEmailTransport'] to see the possible values for this operation
     *
     * @throws \AirEml\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \AirEml\Model\EmailTransportResponse|\AirEml\Model\ErrorMultiple|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error|\AirEml\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
