...
/**
 * PushTemplateContentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PushTemplateContentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushTemplateContentRequest';
    ...
    */
     ...
     * Sets title
     *
     * @param string $title The is a title of the push notification.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string $body The is a body of the push notification.
     *
     * @return self
     */
