...
/**
 * EmailTemplateContentCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailTemplateContentCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailTemplateContentCreateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['text_html'] === null) {
            $invalidProperties[] = "'text_html' can't be null";
        }
     ...
     * Sets subject
     *
     * @param string $subject The is a subject of the email notification.
     *
     * @return self
     */
     ...
     * Sets text_html
     *
     * @param string $text_html This is an HTML part of the body of the email notification.
     *
     * @return self
     */
