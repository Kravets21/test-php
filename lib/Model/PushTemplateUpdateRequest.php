...
/**
 * PushTemplateUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PushTemplateUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushTemplateUpdateRequest';
    ...
    */
    ...
    public function setBadge($badge)
    {
        ...
        if (($badge < 1)) {
            throw new \InvalidArgumentException('invalid value for $badge when calling PushTemplateUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param int|null $status The status of the Template.
     *
     * @return self
     */
