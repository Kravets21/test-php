...
class AuthToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token A JSON Web Token (JWT) that can be used to authenticate requests to the API.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param \DateTime|null $expires_in The number of seconds until the token expires.
     *
     * @return self
     */
